package com.wordpress.muhajirassuyuti.app12141418;

import java.util.Scanner;

        
public class app12141418 { //12141418 pembuatan variabel 
   String nama;
    byte level = 1;
    byte kesempatan = 5;
    short tebak;
    ...
    public void Score() {
        ...
        System.out.println("firman\t: 70");
        System.out.println("budi\t: 50");
        System.out.println("dimas\t: 100");
        System.out.println("fitri\t: 100");
    }
    
    public static void main(String[] args) {
        app12141418 main = new app12141418();
